  ...
  const tours = [
    {
      ...
      body: "Follow the seat of state power from KICC to August Memorial Park. Every step was built to project authority, control resources, or organize power over people. Includes sites where movement held critical detention chambers.",
      route: "KICC to August Memorial Park",
      duration: "5 hours",
      tag: "Political City",
